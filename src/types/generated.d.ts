...
type CrossReferencedEvent = Node &
  UniformResourceLocatable & {
    /** Identifies the actor who performed the event. */
    actor?: Maybe<Actor>
    /** Identifies the date and time when the object was created. */
...
type EnterpriseUserAccount = Node &
  Actor & {
...
type MembersCanDeleteReposClearAuditEntry = Node &
  AuditEntry &
...
type MembersCanDeleteReposDisableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type MembersCanDeleteReposEnableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type OauthApplicationCreateAuditEntry = Node &
  AuditEntry &
...
type OrgAddBillingManagerAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgAddMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgBlockUserAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgConfigDisableCollaboratorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgConfigEnableCollaboratorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgDisableOauthAppRestrictionsAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgDisableSamlAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgDisableTwoFactorRequirementAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgEnableOauthAppRestrictionsAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgEnableSamlAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgEnableTwoFactorRequirementAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgInviteMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgInviteToBusinessAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type OrgOauthAppAccessApprovedAuditEntry = Node &
  AuditEntry &
  OauthApplicationAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type OrgOauthAppAccessDeniedAuditEntry = Node &
  AuditEntry &
  OauthApplicationAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type OrgOauthAppAccessRequestedAuditEntry = Node &
  AuditEntry &
  OauthApplicationAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type OrgRemoveBillingManagerAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgRemoveMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgRemoveOutsideCollaboratorAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgRestoreMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgUnblockUserAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgUpdateDefaultRepositoryPermissionAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgUpdateMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgUpdateMemberRepositoryCreationPermissionAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type OrgUpdateMemberRepositoryInvitationPermissionAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData & {
    /** The action name */
    action: Scalars['String']
...
type PrivateRepositoryForkingDisableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData &
...
type PrivateRepositoryForkingEnableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
...
type PullRequestCommitCommentThread = Node &
  RepositoryNode & {
    /** The comments that exist in this thread. */
    comments: CommitCommentConnection
    /** The commit the comments were made on. */
...
type PullRequestReviewComment = Node &
  Comment &
  Deletable &
  Minimizable &
  Updatable &
...
type RepoAccessAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoAddMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoAddTopicAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData &
  TopicAuditEntryData & {
...
type RepoArchivedAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepoChangeMergeSettingAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepoConfigDisableAnonymousGitAccessAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigDisableCollaboratorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigDisableContributorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigDisableSockpuppetDisallowedAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigEnableAnonymousGitAccessAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigEnableCollaboratorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigEnableContributorsOnlyAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigEnableSockpuppetDisallowedAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigLockAnonymousGitAccessAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoConfigUnlockAnonymousGitAccessAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoCreateAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepoDestroyAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepoRemoveMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData & {
    /** The action name */
...
type RepoRemoveTopicAuditEntry = Node &
  AuditEntry &
  RepositoryAuditEntryData &
  OrganizationAuditEntryData &
  TopicAuditEntryData & {
...
type RepositoryVisibilityChangeDisableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepositoryVisibilityChangeEnableAuditEntry = Node &
  AuditEntry &
  EnterpriseAuditEntryData &
  OrganizationAuditEntryData & {
    /** The action name */
...
type RepositoryVulnerabilityAlert = Node &
  RepositoryNode & {
...
/** Represents a 'review_dismissed' event on a given issue or pull request. */
type ReviewDismissedEvent = Node &
  UniformResourceLocatable & {
    /** Identifies the actor who performed the event. */
    actor?: Maybe<Actor>
    /** Identifies the date and time when the object was created. */
...
type TeamAddMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  TeamAuditEntryData & {
    /** The action name */
...
type TeamAddRepositoryAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData &
  TeamAuditEntryData & {
...
type TeamChangeParentTeamAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  TeamAuditEntryData & {
    /** The action name */
...
type TeamDiscussionComment = Node &
  Comment &
  Deletable &
  Reactable &
  UniformResourceLocatable &
...
type TeamRemoveMemberAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  TeamAuditEntryData & {
    /** The action name */
...
type TeamRemoveRepositoryAuditEntry = Node &
  AuditEntry &
  OrganizationAuditEntryData &
  RepositoryAuditEntryData &
  TeamAuditEntryData & {
