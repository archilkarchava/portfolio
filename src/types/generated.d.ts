...
type Bot = Node & Actor & UniformResourceLocatable & {
...
/** A check run. */
type CheckRun = Node & UniformResourceLocatable & RequirableByPullRequest & {
...
type Commit = Node & GitObject & Subscribable & UniformResourceLocatable & {
  /** An abbreviated version of the Git object ID */
  abbreviatedOid: Scalars['String'];
...
type CommitComment = Node & Comment & Deletable & Minimizable & Updatable & UpdatableComment & Reactable & RepositoryNode & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
  /** Author's association with the subject of the comment. */
  authorAssociation: CommentAuthorAssociation;
...
type CrossReferencedEvent = UniformResourceLocatable & Node & {
  /** Identifies the actor who performed the event. */
  actor?: Maybe<Actor>;
  /** Identifies the date and time when the object was created. */
  createdAt: Scalars['DateTime'];
...
type Discussion = Comment & Updatable & Deletable & Labelable & Lockable & RepositoryNode & Subscribable & Reactable & Votable & Node & {
...
type DiscussionComment = Comment & Deletable & Minimizable & Updatable & UpdatableComment & Reactable & Votable & Node & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
  /** Author's association with the subject of the comment. */
  authorAssociation: CommentAuthorAssociation;
...
/** Enterprise information only visible to enterprise owners. */
type EnterpriseOwnerInfoPendingCollaboratorsArgs = {
  query?: Maybe<Scalars['String']>;
  orderBy?: Maybe<RepositoryInvitationOrder>;
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
...
/** A user with an invitation to be a collaborator on a repository owned by an organization in an enterprise. */
type EnterprisePendingCollaboratorEdgeRepositoriesArgs = {
  after?: Maybe<Scalars['String']>;
  before?: Maybe<Scalars['String']>;
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
...
type GistComment = Node & Comment & Deletable & Minimizable & Updatable & UpdatableComment & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
...
type Issue = Node & Assignable & Closable & Comment & Updatable & UpdatableComment & Labelable & Lockable & Reactable & RepositoryNode & Subscribable & UniformResourceLocatable & {
  /** Reason that the conversation was locked. */
  activeLockReason?: Maybe<LockReason>;
  /** A list of Users assigned to this object. */
  assignees: UserConnection;
...
type IssueComment = Node & Comment & Deletable & Minimizable & Updatable & UpdatableComment & Reactable & RepositoryNode & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
  /** Author's association with the subject of the comment. */
  authorAssociation: CommentAuthorAssociation;
...
type Mannequin = Node & Actor & UniformResourceLocatable & {
  /** A URL pointing to the GitHub App's public avatar. */
  avatarUrl: Scalars['URI'];
...
type MembersCanDeleteReposClearAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type MembersCanDeleteReposDisableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type MembersCanDeleteReposEnableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type Milestone = Node & Closable & UniformResourceLocatable & {
  /** `true` if the object is closed (definition of closed may depend on type) */
  closed: Scalars['Boolean'];
  /** Identifies the date and time when the object was closed. */
  closedAt?: Maybe<Scalars['DateTime']>;
...
type OauthApplicationCreateAuditEntry = Node & AuditEntry & OauthApplicationAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgAddBillingManagerAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgAddMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgBlockUserAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgConfigDisableCollaboratorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgConfigEnableCollaboratorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgCreateAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgDisableOauthAppRestrictionsAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgDisableSamlAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgDisableTwoFactorRequirementAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgEnableOauthAppRestrictionsAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgEnableSamlAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgEnableTwoFactorRequirementAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgInviteMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgInviteToBusinessAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgOauthAppAccessApprovedAuditEntry = Node & AuditEntry & OauthApplicationAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgOauthAppAccessDeniedAuditEntry = Node & AuditEntry & OauthApplicationAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgOauthAppAccessRequestedAuditEntry = Node & AuditEntry & OauthApplicationAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgRemoveBillingManagerAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgRemoveMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgRemoveOutsideCollaboratorAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgRestoreMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgUnblockUserAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgUpdateDefaultRepositoryPermissionAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgUpdateMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgUpdateMemberRepositoryCreationPermissionAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type OrgUpdateMemberRepositoryInvitationPermissionAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type Organization = Node & Actor & PackageOwner & ProjectOwner & RepositoryDiscussionAuthor & RepositoryDiscussionCommentAuthor & RepositoryOwner & UniformResourceLocatable & MemberStatusable & ProfileOwner & Sponsorable & {
...
type PrivateRepositoryForkingDisableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type PrivateRepositoryForkingEnableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type Project = Node & Closable & Updatable & {
...
type PullRequest = Node & Assignable & Closable & Comment & Updatable & UpdatableComment & Labelable & Lockable & Reactable & RepositoryNode & Subscribable & UniformResourceLocatable & {
  /** Reason that the conversation was locked. */
  activeLockReason?: Maybe<LockReason>;
...
type PullRequestReview = Node & Comment & Deletable & Updatable & UpdatableComment & Reactable & RepositoryNode & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
  /** Author's association with the subject of the comment. */
  authorAssociation: CommentAuthorAssociation;
...
type PullRequestReviewComment = Node & Comment & Deletable & Minimizable & Updatable & UpdatableComment & Reactable & RepositoryNode & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
  /** Author's association with the subject of the comment. */
  authorAssociation: CommentAuthorAssociation;
...
type Release = Node & UniformResourceLocatable & Reactable & {
...
type RepoAccessAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoAddMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoAddTopicAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & TopicAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoArchivedAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoChangeMergeSettingAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigDisableAnonymousGitAccessAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigDisableCollaboratorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigDisableContributorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigDisableSockpuppetDisallowedAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigEnableAnonymousGitAccessAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigEnableCollaboratorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigEnableContributorsOnlyAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigEnableSockpuppetDisallowedAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigLockAnonymousGitAccessAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoConfigUnlockAnonymousGitAccessAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoCreateAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoDestroyAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoRemoveMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepoRemoveTopicAuditEntry = Node & AuditEntry & RepositoryAuditEntryData & OrganizationAuditEntryData & TopicAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type Repository = Node & ProjectOwner & PackageOwner & Subscribable & Starrable & UniformResourceLocatable & RepositoryInfo & {
...
type RepositoryVisibilityChangeDisableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RepositoryVisibilityChangeEnableAuditEntry = Node & AuditEntry & EnterpriseAuditEntryData & OrganizationAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type RequestedReviewer = Mannequin | Team | User;
...
type StatusContext = RequirableByPullRequest & Node & {
...
type Team = Node & Subscribable & MemberStatusable & {
...
type TeamAddMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & TeamAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type TeamAddRepositoryAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & TeamAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type TeamChangeParentTeamAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & TeamAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
/** A team discussion. */
type TeamDiscussion = Node & Comment & Deletable & Reactable & Subscribable & UniformResourceLocatable & Updatable & UpdatableComment & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
...
type TeamDiscussionComment = Node & Comment & Deletable & Reactable & UniformResourceLocatable & Updatable & UpdatableComment & {
  /** The actor who authored the comment. */
  author?: Maybe<Actor>;
...
type TeamRemoveMemberAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & TeamAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type TeamRemoveRepositoryAuditEntry = Node & AuditEntry & OrganizationAuditEntryData & RepositoryAuditEntryData & TeamAuditEntryData & {
  /** The action name */
  action: Scalars['String'];
  /** The user who initiated the action */
  actor?: Maybe<AuditEntryActor>;
...
type User = Node & Actor & PackageOwner & ProjectOwner & RepositoryDiscussionAuthor & RepositoryDiscussionCommentAuthor & RepositoryOwner & UniformResourceLocatable & ProfileOwner & Sponsorable & {
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'];
...
type PinnedRepositoriesQueryVariables = Exact<{
  login: Scalars['String'];
  amount: Scalars['Int'];
}>;
